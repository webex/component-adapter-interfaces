...
/**
 * An object that represents a media stream and its permission.
 *
 ...
 * @property {MeetingStream} localVideo   The local video stream
 * @property {MeetingStream} localAudio   The local audio stream
